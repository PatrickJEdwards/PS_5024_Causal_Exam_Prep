...
- The average treatment effect parameter is the difference in the respective population means, which are themselves estimated by the difference in sample means [**\textcolor{red}{Check Answer}**]:
